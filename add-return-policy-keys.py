...
TRANSLATIONS = {
    'en': {
        ...
        "return_s3_li3": "Once we receive and inspect the item, your refund will be issued within 5–10 business days",
    ...
    'kz': {
        ...
        "return_s3_li3": "Тауарды алып, тексергеннен кейін, ақшаңыз 5–10 жұмыс күні ішінде қайтарылады",
    ...
    'ru': {
        ...
        "return_s3_li3": "После получения и проверки товара возврат средств будет произведён в течение 5–10 рабочих дней",
    ...
    'de': {
        ...
        "return_s3_li3": "Nach Erhalt und Prüfung des Artikels erfolgt die Rückerstattung innerhalb von 5–10 Werktagen",
    ...
    'it': {
        ...
        "return_s3_li3": "Dopo la ricezione e l'ispezione dell'articolo, il rimborso verrà emesso entro 5–10 giorni lavorativi",
    ...
    'tr': {
        ...
        "return_s3_li3": "Ürünü aldıktan ve inceledikten sonra, geri ödemeniz 5–10 iş günü içinde yapılacaktır",
    ...
    'nl': {
        ...
        "return_s3_li3": "Na ontvangst en inspectie van het artikel wordt uw terugbetaling binnen 5–10 werkdagen uitgevoerd",
    ...
    'pl': {
        ...
        "return_s3_li3": "Po otrzymaniu i sprawdzeniu przedmiotu zwrot środków zostanie zrealizowany w ciągu 5–10 dni roboczych",
